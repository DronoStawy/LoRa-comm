...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.rebootButton = QPushButton(self.groupBox)
        self.rebootButton.setObjectName(u"rebootButton")
        self.rebootButton.setGeometry(QRect(10, 20, 121, 41))
        self.flashButton = QPushButton(self.groupBox)
        self.flashButton.setObjectName(u"flashButton")
        self.flashButton.setGeometry(QRect(10, 60, 121, 41))
        ...
        self.refreshPortsButton = QPushButton(self.groupBox_5)
        self.refreshPortsButton.setObjectName(u"refreshPortsButton")
        self.refreshPortsButton.setGeometry(QRect(100, 60, 31, 31))
        ...
        self.baudComboBox.setGeometry(QRect(0, 60, 101, 32))
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.rebootButton.setText(QCoreApplication.translate("mainWindow", u"Reboot", None))
        ...
        self.refreshPortsButton.setText(QCoreApplication.translate("mainWindow", u"\u21bb", None))
